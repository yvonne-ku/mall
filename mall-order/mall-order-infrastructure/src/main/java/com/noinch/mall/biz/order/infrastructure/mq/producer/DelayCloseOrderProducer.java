...
public class DelayCloseOrderProducer {
     ...
     *
     */
    public void delayCloseOrderSend(Order order) {
        try {
            ...
            rabbitTemplate.convertAndSend(
                    ...
                    message -> {
                        // 1. 设置唯一消息 ID
                        String messageId = "DELAY_ORDER_" + order.getOrderSn();
            ...
            log.info("延迟关单消息发送成功, 订单号: {}, 消息ID: {}", order.getOrderSn(), "DELAY_ORDER_" + order.getOrderSn());
        } catch (Exception e) {
