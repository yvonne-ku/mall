...
(
    `id`                   bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `product_spu_id`       bigint(20) DEFAULT NULL COMMENT '商品 ID',
    `product_attribute_id` bigint(20) DEFAULT NULL COMMENT '商品属性 ID',
...
(
    ...
    `product_spu_id`       bigint(20) DEFAULT NULL COMMENT '商品ID',
    ...
    KEY                `idx_product_spu_id` (`product_spu_id`) USING BTREE
...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `id` (`id`),
    KEY           `idx_brand_id_product_spu_id` (`brand_id`,`product_spu_id`) USING BTREE
...
(
    ...
    `recommend_status`     tinyint(1) DEFAULT NULL COMMENT '推荐状态 0：推荐 1：非推荐',
    `create_time`          datetime       DEFAULT NULL COMMENT '创建时间',
    `update_time`          datetime       DEFAULT NULL COMMENT '修改时间',
    `del_flag`             tinyint(1) DEFAULT NULL COMMENT '删除标记 0：未删除 1：删除',
    PRIMARY KEY (`id`),
...
INSERT INTO `product_attribute_value` (`id`, `product_spu_id`, `product_attribute_id`, `attribute_value`, `create_time`,
...
INSERT INTO `product_sku_0` (`id`, `category_id`, `brand_id`, `product_spu_id`, `price`, `stock`, `lock_stock`, `pic`,
...
INSERT INTO `product_spu_0` (`id`, `category_id`, `brand_id`, `name`, `product_sn`, `pic`, `photo_album`, `price`,
                             ...
                             `unit`, `detail`, `publish_status`, `new_status`, `recommend_status`, `create_time`,
                             `update_time`, `del_flag`)
