...
CREATE TABLE `customer_operation_log_0`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
...
CREATE TABLE `customer_operation_log_1`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_10`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_11`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_12`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_13`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_14`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_15`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_2`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_3`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_4`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_5`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_6`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_7`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_8`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
CREATE TABLE `customer_operation_log_9`
(
    `id`                bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `customer_id`       bigint(20) DEFAULT NULL COMMENT 'C端用户 ID',
    `before_content`    varchar(2048) DEFAULT NULL COMMENT '修改前',
...
INSERT INTO `customer_0` (`id`, `name`, `account`, `password`, `phone`, `mail`, `age`, `gender`, `avatar`,
                               `create_time`, `update_time`, `del_flag`)
VALUES ('1634554535496892416', '马称', '15601166691312312', 'sdkfjklKJFpdensfKjnfdiked89ifskj',
...
INSERT INTO `receive_address_0` (`id`, `customer_id`, `name`, `phone`, `default_flag`, `tag`, `post_code`,
