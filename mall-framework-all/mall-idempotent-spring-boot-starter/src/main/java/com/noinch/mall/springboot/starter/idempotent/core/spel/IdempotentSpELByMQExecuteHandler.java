...
import com.noinch.mall.springboot.starter.idempotent.core.*;
import com.noinch.mall.springboot.starter.idempotent.enums.IdempotentMQConsumeStatusEnum;
import com.noinch.mall.springboot.starter.idempotent.toolkit.LogUtil;
...
public final class IdempotentSpELByMQExecuteHandler extends AbstractIdempotentTemplate implements IdempotentSpELService {
    ...
    public void handler(IdempotentParamWrapper wrapper) {
        ...
        // 如果 setIfAbsent 为 false，说明已经存在，因此重复消费
    ...
    /**
     * 当被幂等保护的方法执行抛出异常时，删除本次消费预留的幂等标识，允许消息后续重试。
     */
    @Override
    ...
    /**
     * 当被幂等保护的方法正常执行完毕后（无异常抛出），该方法会被调用，负责将幂等标识从 “消费中” 更新为 “已消费”，并重新设置过期时间。
     */
    @Override
