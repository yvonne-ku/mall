package com.noinch.mall.springboot.starter.distributedid.core.snowflakeid;
 ...
 * 然后是 5 位 datacenterId 和 5 位workerId(10位的长度最多支持部署1024个节点）<br>
